...
function renderSourcePage(){
  ...
  wrap.innerHTML = `
    ...
    ${pageBody}
    <div class="src-highlight-notice">
      <span class="src-highlight-badge">HIGHLIGHT</span>
